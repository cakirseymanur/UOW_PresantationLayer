...
using UOW_BusinessLayer.Concrete;
using UOW_DataAccessLayer.Abstract;
using UOW_DataAccessLayer.Concrete;
using UOW_DataAccessLayer.EntityFramework;
using UOW_DataAccessLayer.UnitOfWork;

namespace UOW_PresantationLayer
{
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=Account}/{action=ProcessDetailIndex}/{id?}");
            });
        }
    }
}
